...
class Bls12381g2ValidationError extends TokenValidationError {
  ...
  Bls12381g2ValidationError(value, Token token, String baseMessage)
      : super(value, token, baseMessage);
}

class Bls12381g2Token extends Token {
  static String prim = 'bls12_381_g2';

  Bls12381g2Token(MichelsonV1Expression val, int idx, fac)
      : super(val, idx, fac);

  isValid(dynamic value) =>
      RegExp(r"^[0-9a-fA-F]*$").hasMatch(value) && value.length % 2 == 0
          ? null
          : new Bls12381g2ValidationError(val, this, 'Invalid bytes: $val');
  ...
  @override
  extractSchema() => Bls12381g2Token.prim;
}
